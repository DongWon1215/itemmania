...
public class BoardSearchService {
    ...
    public List<BoardEntity> getSearchDataCheck(Pageable pageable, String dealCheck, String gameName, String gameServerName) {
        log.info(dealCheck);
        log.info(gameName + gameServerName);

        List<BoardEntity> list = boardRepository.boardSearchList(pageable, dealCheck, gameName, gameServerName);
